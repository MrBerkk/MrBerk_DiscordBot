...
exports.run = (client, message, args) => {
  ...
  let modlog = guild.channels.find('name', '💬ɢᴇɴᴇʟ-sᴏʜʙᴇᴛ');
  if (!modlog) return message.reply('`💬ɢᴇɴᴇʟ-sᴏʜʙᴇᴛ`kanalını bulamıyorum.');
  ...
  if (!message.guild.member(user).bannable) return message.reply('Yetkilileri Banlayamam Kardeşim! ');
